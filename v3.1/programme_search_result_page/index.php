		...
		*/
		...
		<script type="text/javascript">
			$(document).ready(function() {
				if($(window).width() <= 768){
					$(".Search_condition_region").removeClass("S_open");
					$(".Search_condition_region").addClass("S_close");
					$(".Search_condition_region").slideUp("slow");
				}else{
					$(".Search_condition_region").removeClass("S_close");
					$(".Search_condition_region").addClass("S_open");
					$(".Search_condition_region").slideDown("slow");		
				}
				
				$(".Quick_search_btn").click(function(){		
					if($(".Search_condition_region").hasClass("S_open")){
						$(".Search_condition_region").removeClass("S_open");
						$(".Search_condition_region").addClass("S_close");
						$(".Search_condition_region").slideUp("slow");
					}else if($(".Search_condition_region").hasClass("S_close")){
						$(".Search_condition_region").removeClass("S_close");
						$(".Search_condition_region").addClass("S_open");
						$(".Search_condition_region").slideDown("slow");
					}					
					...
					<div class="Body_region_left col-xs-12 col-sm-12 col-md-8 col-lg-8">
						<div class="row Programme_title_region">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<a href="#" class="Quick_search_btn btn btn-primary btn-sm">
